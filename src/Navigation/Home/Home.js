    ...
    <>
      <div className="text-center" id="container-home">
        <img
          ...
          alt=""
        />
        <h1 className="text-center fw-bold" style={{ fontSize: 72 }}>
          Emely
        </h1>
        <hr />
        ...
        <Button
          ...
          className="w-100 mt-5 rounded-pill p-3 fw-bold register-btn_light"
        >
        ...
        <Link to="/login">
          <Button
            variant="success"
            className="w-100 mt-3 rounded-pill p-3 fw-bold register-btn"
          >
